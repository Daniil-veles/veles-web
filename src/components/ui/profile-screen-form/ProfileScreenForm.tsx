...
const ProfileScreenForm: React.FC = () => {
  ...
  useEffect(() => {
    if (userInfo) {
      ...
      const [day, month, year] = userInfo.birthDate.split("."); // Разбиваем дату по точкам
      const formattedDate = `${year}-${month}-${day}`; // Преобразуем в формат 'YYYY-MM-DD'
